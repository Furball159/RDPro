...
public static class UiService
{
    ...
    public static async Task<bool> ShowInfoAsync(string title, string message, string confirmText = "Yes", string cancelText = "No")
    {
        try
        {
            if (Application.Current?.ApplicationLifetime is Avalonia.Controls.ApplicationLifetimes.IClassicDesktopStyleApplicationLifetime desktop)
            {
                ...
                var ok = new Button { Content = "Okay", Width = 80, Margin = new Thickness(6,0) };
